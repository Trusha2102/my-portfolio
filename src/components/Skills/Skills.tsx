...
const skills = {
  BackEnd: [
    ...
    { name: "ASP.NET Core", logo: "/icons/dotnet-core.png" },
  ...
  Database: [
    ...
    { name: "MariaDB", logo: "/icons/mariadb.png" },
    {name: "Redis", logo:"/icons/redis.png"},
  ...
  FrontEnd: [
    ...
    { name: "Angular.js", logo: "/icons/angularjs.png" },
    {name:"jQuery", logo:"/icons/jquery.png"},
  ...
  Tools: [
    ...
    {name: 'HeidiSQL', logo: "/icons/heidisql.png"}
  ],
};
