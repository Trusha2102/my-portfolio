...
export default function Experience() {
  const experiences = [
    ...
    },
    {
      ...
      description:
        "As a Node.js Developer on the HDFC International project, I worked closely with international clients to deliver robust backend solutions. My responsibilities included implementing secure systems with Node.js, Express, and PostgreSQL, focusing on areas such as authentication, encryption, and debugging. Additionally, I collaborated on API integration with a React-based frontend, ensuring seamless communication between the backend and frontend components.",
    },
    {
      company: "Digiqt Technolabs",
